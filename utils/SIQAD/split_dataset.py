...
save_dataset_root = os.path.join(os.path.join(os.path.abspath(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'DataSet'), 'SIQAD')
...
test_images = []
total_images = []
read_path = os.path.join('/data/zjy/MEFGIQA/622/SIQAD/', 'image32.csv')  # 指定划分的文件
