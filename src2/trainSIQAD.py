...
from models2.model_base import MyNet
from utils.SIQAD2.data import train_loader, val_loader, test_loader
...
test_images = []
read_path = os.path.join(os.path.join(os.path.join(os.path.abspath(os.path.join(os.getcwd(), "..")), 'utils'), 'SIQAD2'), 'test.csv')
print(read_path)
