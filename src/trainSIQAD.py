...
from utils.SIQAD.data import train_loader, val_loader, test_loader
...
test_images = []
read_path = os.path.join(os.path.join(os.path.join(os.path.abspath(os.path.join(os.getcwd(), "..")), 'utils'), 'SIQAD'), 'test.csv')
print(read_path)
